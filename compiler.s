...
; 	override:
; 		dec rax
; 		mov r14, qword[rbp-WORD_SIZE*r13]
; 		mov qword[rbp+WORD_SIZE*rax], r14
; 		inc r13
; 		dec r8
; 		cmp r8,0
...
; 	;mov r9, %1 ;%1 is r9 already
; 	mov rcx, %1 ;%1 is r9, move to rcx for loop
; 	override:
; 		dec rax
; 		mov r14, qword[rbp-WORD_SIZE*i]
; 		mov qword[rbp+WORD_SIZE*rax], r14
